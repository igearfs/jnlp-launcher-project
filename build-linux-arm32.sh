...
# Usage: ./build-linux-x64.sh <jar-file> <java-home>

JAR_FILE="$1"
JAVA_HOME="$2"

echo "Running jpackage for Linux ARM32..."
...
APP_CONTENT="4.5.2,javafx-linux-arm32"
...
echo "Creating Linux ARM32 package with jpackage..."
